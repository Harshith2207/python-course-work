...
if Monster_cp >= 500:
    print(f"{Monster_name} is a powerhouse! High CP detected.")
elif Monster_cp >= 300:
    print(f"{Monster_name} is strong and ready for mid-level battles.")
else:
    print(f"{Monster_name} might need some training to improve CP.")

if catch_rate >= 50:
    print("Easy to catch — high success rate!")
elif catch_rate >= 20:
    print("Moderate catch rate — be careful!")
else:
    print("Difficult to catch — bring Ultra Balls!")

if "fire" in [t.lower() for t in Monster_types]:
    print("It's a Fire-type Pokémon. Watch out for water!")
elif "water" in [t.lower() for t in Monster_types]:
    print("It's a Water-type Pokémon. Electricity is a threat!")

if not available:
    print("This Pokémon is currently unavailable for battles.")
else:
    print("This Pokémon is ready to battle!")
